...
public class MatchesController {
    ...
    public String showAdd(Model model) {
        model.addAttribute("matchTypes",MatchType.values());
        model.addAttribute("matchLocations",this.matchLocationService.listAll());
        return "form";
    }
     ...
     */
    @PostMapping("/matches")
    public String create(@RequestParam String name,@RequestParam  String description,@RequestParam  Double price,@RequestParam  MatchType type,@RequestParam  Long location) {
