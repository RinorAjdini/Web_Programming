...
{
    List<VirtualServer> findAllByOwnersContainingAndLaunchDateIsBefore(User user, LocalDate launchDate);
    List<VirtualServer> findAllByOwnersContaining(User user);
    List<VirtualServer> findAllByLaunchDateIsBefore(LocalDate launchDate);
}
